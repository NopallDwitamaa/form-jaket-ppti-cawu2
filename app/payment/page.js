      ...
      <div className="w-full max-w-lg">
        ...
        <div className="bg-white border border-gray-200 shadow-2xl w-full p-8 rounded-3xl">
          ...
          <div className="mb-6">
            ...
            <label
              className={`flex flex-col items-center justify-center border-2 border-dashed border-indigo-400 bg-indigo-50 rounded-xl p-6 cursor-pointer transition ${loading ? "opacity-50 cursor-not-allowed" : "hover:bg-indigo-100"}
          `}
            >
